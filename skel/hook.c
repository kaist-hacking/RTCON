...
struct playGround newPlayGround;
...
getPlayGround(void *in) {
  ...
  newPlayGround.hashval = hashval;
  newPlayGround.out = malloc(PLAYGROUND_SIZE);
  hashmap_set(playGroundMap, &newPlayGround);
...
sanitizeCall7(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { sanitizeCall7Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH {}
  END_TRY;
...
sanitizeCall13_1(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { TRYRET sanitizeCall13_1Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH { CATCHRET 0; }
  END_TRY;
...
sanitizeCall13_8(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { TRYRET sanitizeCall13_8Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH { CATCHRET 0; }
  END_TRY;
...
sanitizeCall13_16(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { TRYRET sanitizeCall13_16Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH { CATCHRET 0; }
  END_TRY;
...
sanitizeCall13_32(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { TRYRET sanitizeCall13_32Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH { CATCHRET 0; }
  END_TRY;
...
sanitizeCall13_64(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY { TRYRET sanitizeCall13_64Orig(a1, a2, a3, a4, a5, a6, a7, a8); }
  CATCH { CATCHRET 0; }
  END_TRY;
...
sanitizeCall15(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY {
    void *result = sanitizeCall15Orig(a1, a2, a3, a4, a5, a6, a7, a8);
...
sanitizeCall16(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  TRY {
    void *result = sanitizeCall16Orig(a1, a2, a3, a4, a5, a6, a7, a8);
 ...
 * 
 */
int (*IndirectLinks[256])(void *, void *, void *, void *, void *, void *, void *,
                       void *);
...
callIndirectLink(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
  ...
  IndirectLinks[callIndex](a1, a2, a3, a4, a5, a6, a7, a8);
  return 0;
...
void (*sanitizeIndirectCall7Orig)(void *, void *, void *, void *, void *,
                                  void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) void
sanitizeIndirectCall7(void *a1, void *a2, void *a3, void *a4, void *a5,
  ...
  CATCH { 
    if (checkIndirectLink) {
      checkIndirectLink = false;
      callIndirectLink(a1, a2, a3, a4, a5, a6, a7, a8);
    }
    CATCHRET;
  }
  END_TRY;
...
int (*sanitizeIndirectCall13_1Orig)(void *, void *, void *, void *, void *,
                                    void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
...
int (*sanitizeIndirectCall13_8Orig)(void *, void *, void *, void *, void *,
                                    void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
...
int (*sanitizeIndirectCall13_16Orig)(void *, void *, void *, void *, void *,
                                     void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
...
int (*sanitizeIndirectCall13_32Orig)(void *, void *, void *, void *, void *,
                                     void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
...
int (*sanitizeIndirectCall13_64Orig)(void *, void *, void *, void *, void *,
                                     void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
...
void *(*sanitizeIndirectCall15Orig)(void *, void *, void *, void *, void *,
                                    void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) void *
...
void *(*sanitizeIndirectCall16Orig)(void *, void *, void *, void *, void *,
                                    void *, void *, void *);
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) void *
 ...
 ******************************************************************************/
char searchFuncName[1024];
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
getFuncNamefromAddr(void *addr);
...
registerEntryFunction(void (*func)(void *, void *, void *, void *, 
  ...
  for (int i = 1; i < MAX_ENTRY_FUNCTION; i++) {
    ...
    if ((entryFunctionList[i].func == NULL) && (getFuncNamefromAddr(func) != -1)) {
      if (isSanitizedScope(searchFuncName)) {
        /* If we already visited this function, skip it */
        return 1;
      }
      ...
      entryFunctionList[i].depth = depth;
      memset(entryFunctionList[i].funcName, 0, sizeof(entryFunctionList[i].funcName));
...
__attribute__((no_sanitize("coverage"), no_sanitize("address"))) int
updateEntryFunctionName(void (*func)(void *, void *, void *, void *, 
                                     void *, void *, void *, void *),
                        char *funcName) {
  for (int i = 0; i < MAX_ENTRY_FUNCTION; i++) {
    if (entryFunctionList[i].func == func) {
      snprintf(entryFunctionList[i].funcName, sizeof(entryFunctionList[i].funcName), "%s", funcName);
      return 0;
    }
  }
  return 1;
...
crossEntryPoints(void *input, uint64_t length) {
  ...
  if (entryFunctionList[target].func) {
    ...
    if (checkCrossValid(&input, input_index, &length, length_index)) {
      ...
      entryFunctionList[target].func(a1, a2, a3, a4, a5, a6, a7, a8);
      return 1;
    }
    return 0;
  }
...
LLVMFuzzerInitialize(int *argc, char ***argv) {
  ...
  if (memcmp(filename, "riot", 4) == 0) {
    snprintf(nmCmd, sizeof(nmCmd), "nm %s > %s", path, outputFile);
  } else {
    snprintf(nmCmd, sizeof(nmCmd), "nm %s > %s", (*argv)[0], outputFile);
  }
  system(nmCmd);

  snprintf(nmFileName, sizeof(nmFileName), "%s", outputFile);

#ifdef MULTI_ENTRY_DEPTH_CHECK
  /* This will dramatically decrease the fuzzing efficiency */
  /* multi_entry list */
          ...
          if (funcName) {
            if (strcmp(funcName, entryFuncName) == 0) {
              ...
              if (registerEntryFunction(func, inputIndexInt, lengthIndexInt, funcDepth) == 0) {
                updateEntryFunctionName(func, entryFuncName);
...
getFuncNamefromAddr(void *addr) {
  FILE *nmfp = fopen(nmFileName, "r");
  snprintf(searchFuncName, sizeof(searchFuncName), "");
  ...
  if (nmfp) {
    ...
    while (fgets(nmLine, sizeof(nmLine), nmfp)) {
      ...
      char *funcName = strtok(NULL, " ");
      if (funcName) {
        if (strtoull(funcAddr, NULL, 16) == (uint64_t)addr) {
          snprintf(searchFuncName, sizeof(searchFuncName), "%s", funcName);
          break;
        }
      }
    }
