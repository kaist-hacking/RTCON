            ...
            if file.endswith(".c"):
                ...
                with open(filepath, "r", encoding="utf-8", errors="ignore") as f:
                    ...
                    for match in matches:
                        if "gnrc_pktsnip_t*" not in match.replace(" ", ""):
                            continue
                        if "gnrc_pktsnip_t**" in match.replace(" ", ""):
                            continue
                        ...
                        for i, param in enumerate(params.split(",")):
                            if "gnrc_pktsnip_t*" in param.replace(" ", ""):
...
if __name__ == "__main__":
    ...
    protos = get_nxpacket(sys.argv[1])
