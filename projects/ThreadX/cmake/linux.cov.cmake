...
set(CMAKE_C_COMPILER    cov-cgcc)
set(CMAKE_CXX_COMPILER  cov-cgcc++)
#set(AS                  as)
#set(AR                  ar)
#set(OBJCOPY             objcopy)
#set(OBJDUMP             objdump)
...
set(CMAKE_C_FLAGS "-g -O0 -fno-inline" CACHE INTERNAL "c compiler flags")
...
set(CMAKE_EXE_LINKER_FLAGS "${LD_FLAGS} -Wl,--gc-sections -fsanitize=address -fno-omit-frame-pointer -fsanitize-recover=address -rdynamic" CACHE INTERNAL "exe link flags")
