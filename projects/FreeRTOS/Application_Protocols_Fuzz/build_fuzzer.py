...
TEST_FUNC_LIST = "/configs/freertos-app-func-list-reduced.txt"
        ...
        try:
            ...
            if first_build:
                ...
                if os.path.exists(taint_update_func_file):
                    ...
                    shutil.copy(f"{build_dir}/freertos-app-fuzz", f"./host_bin/freertos-app-{func_name}-fuzz")
                    break
